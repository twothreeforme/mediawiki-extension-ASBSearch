...
//                     "</div>" .
    ...
    public function showEquipsets(){
        $html = "<span><b>THIS IS STILL UNDER CONSTRUCTION. ALL SAVED CHARS & SETS MAY BE DELETED AS WE CONTINUE DEVELOPMENT OF THIS TOOL.</b><br>" .
                    ...
                    "<i><b>Usage:</b> Share button disabled for now as this is being restructured. Known issue with stat boosts from gear remaining on the 'Statistics' section after the gear as been removed.</i></span>" .
