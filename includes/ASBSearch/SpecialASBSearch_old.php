...
////////////////////////////////////////////
		 ...
		 */
			...
			$queryData = [ $this->query_limit, $mobNameSearch, $itemNameSearch,
							...
							$this->levelRangeMIN, $this->levelRangeMAX, $this->thRatesCheck
						 ];
			...
			$wikitext = self::showQueryResults($dm->getDataSet(), $this->thRatesCheck );
	...
	// function getDropRates($zoneNameSearch, $mobNameSearch, $itemNameSearch, $queryLimit){
